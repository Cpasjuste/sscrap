...
elseif (PLATFORM_VITA)
    ...
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -mtune=cortex-a9 -mfpu=neon -mfloat-abi=hard -Wl,-q" CACHE STRING "" FORCE)
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -mtune=cortex-a9 -mfpu=neon -mfloat-abi=hard -Wl,-q" CACHE STRING "" FORCE)
